if(KODI_DEPENDSBUILD)
  ...
  if(ENABLE_DVDCSS OR CORE_SYSTEM_NAME MATCHES windows)
  ...
  if(ENABLE_DVDCSS OR CORE_SYSTEM_NAME MATCHES windows)
    if(NOT CORE_SYSTEM_NAME MATCHES windows)
      ...
      ExternalProject_Add(dvdcss
        ...
        DOWNLOAD_NAME libdvdcss-${libdvdcss_VER}.tar.gz
        PATCH_COMMAND 
          COMMAND ${PATCH_EXE} --binary -p1 -i ${DEPENDS_TARGETS_DIR}/lib$(TargetName)/0001-added-cmake-build-system.patch
        CMAKE_ARGS
